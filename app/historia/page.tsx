...
// Càrrega segura del JSON des del sistema de fitxers provant diferents rutes
let historyEvents: any[] = [];

try {
  const possiblePaths = [
    path.join(process.cwd(), "calendar-history.generated.json"),
    path.join(process.cwd(), "public", "calendar-history.generated.json"),
    path.resolve("./calendar-history.generated.json"),
  ];
...
const milestones = [
  {
    year: "1914",
    title: "L’arrel",
    text: "A Cornellà de Llobregat es forma l’Orquestra L’Artística Llobregatana, que durant un any porta el nom de Cobla-orquestra Llobregat. D’aquell planter en sortirà la cobla.",
  },
  {
    year: "1929",
    title: "Els primers compassos",
    text: "Dídac Vilà i Moragues funda La Principal del Llobregat a Cornellà amb músics de L’Artística Llobregatana. És l’any que la cobla pren el nom que encara porta.",
  },
  {
    year: "Anys 30",
    title: "Javimel al primer tible",
    text: "El fill del fundador, Jaume Vilà i Mèlich —Javimel—, consolida la formació des del primer tible. Compositor de sardanes com «Records de Can Ribot» i «Com dansen, les Violetes!», toca a la plaça d’Espanya de Barcelona i a la Festa de Germanor de la Font de Can Ribot, a la Colònia Güell.",
  },
  {
    year: "1968",
    title: "Josep Vilà pren el relleu",
    text: "Gran intèrpret de flabiol, Josep Vilà i Figueras assumeix la direcció i la representació durant la segona meitat del segle XX, i situa la cobla entre les formacions més prestigioses del país.",
  },
  {
    year: "Anys 70",
    title: "De la plaça al teatre",
    text: "La cobla és presència fixa al Portal de l’Àngel per la Mercè, a la plaça de la Catedral i fins al camp del FC Barcelona. El 1977 concursa al Premi Agustí Borguñó, al Teatre Municipal La Faràndula de Sabadell.",
  },
  {
    year: "1978",
    title: "Fora de casa",
    text: "El retrat de Berlín obre una etapa de gires: Alemanya, Bèlgica, els Països Baixos i Gal‌les, on la cobla dona el concert inaugural del Festival Internacional de Música de Llangollen.",
  },
  {
    year: "1991",
    title: "Més enllà de les fronteres",
    text: "Representa Catalunya als Dies Catalans de Tunísia, i el seu so arriba fins a Nova York i l’Argentina. També esdevé capdavantera en l’acompanyament dels grans esbarts dansaires.",
  },
  {
    year: "2004",
    title: "75 anys i Creu de Sant Jordi",
    text: "El 75è aniversari es celebra al Parc de Can Mercader de Cornellà, amb Josep Vilà i Antoni Ros-Marbà com a convidats d’excepció, i la Generalitat li atorga la Creu de Sant Jordi.",
  },
  {
    year: "50+",
    title: "Una discografia extensa",
    text: "Més de cinquanta enregistraments documenten la seva evolució: el disc dirigit per Salvador Brotons (2004), les sardanes de Joan Jordi Beumala (2013), el treball del 90è aniversari (2019) i «Directe», enregistrat en viu al Pla de la Catedral de Barcelona. També hi consta l’adopció de la tenora barítona dins la cobla.",
  },
  {
    year: "2025—26",
    title: "Nous diàlegs",
    text: "La Principal del Llobregat estrena un espectacle amb el Quartet Mèlt i obre el so de la cobla a noves complicitats, amb la veu lírica de Guillem Batllori i el piano d’Emma Stratton.",
  },
  {
    year: "Avui",
    title: "Arrel i moviment",
    text: "Sota la direcció de Marcel Sabaté, la formació continua present en aplecs, cicles de concerts i festivals, mantenint viva una trajectòria que s’acosta al centenari.",
  },
];
      ...
      <section className="historyMapSection sectionPad" aria-labelledby="history-map-title">
        <div className="historyMapHeading">
          <div>
            ...
            <h2 id="history-map-title">
              Una història<br />
              <em>sobre el territori.</em>
            </h2>
          </div>
          <p>
