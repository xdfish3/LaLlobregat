...
// Importem HistoryMap deshabilitant el SSR per evitar errors d'execució en servidor
const HistoryMap = dynamicImport(
  () => import("./HistoryMap").then((mod) => mod.HistoryMap),
  { ssr: false }
);
    ...
    <main id="contingut">
      ...
      <section className="historyOpening sectionPad">
        ...
        <div className="openingText">
          ...
          <p>La Principal del Llobregat va néixer a Cornellà de Llobregat de la mà de Dídac Vilà i Moragues, amb músics sortits de l’Orquestra L’Artística Llobregatana. El seu fill, Jaume Vilà i Mèlich —Javimel—, va consolidar la formació des del primer tible; a partir de 1968, el nét Josep Vilà i Figueras en va prendre el relleu com a director i representant.</p>
          <p>Gairebé cent anys després, la cobla continua fent créixer aquell llegat amb repertori, enregistraments, viatges i projectes compartits.</p>
        </div>
      </section>
      ...
      <section className="sourcesSection sectionPad">
        ...
        <div className="sourceLinks">
          <a href={sitePath("/multimedia/biografia-la-principal-del-llobregat.pdf")} download>Biografia de la cobla <span>↓</span></a>
          <a href={blogPostUrl} target="_blank" rel="noreferrer">Fons documental · La Principal del Llobregat <span>↗</span></a>
          <a href="https://ca.wikipedia.org/wiki/La_Principal_del_Llobregat" target="_blank" rel="noreferrer">Viquipèdia <span>↗</span></a>
          <a href="https://www.palaumusica.cat/1096647" target="_blank" rel="noreferrer">Palau de la Música Catalana <span>↗</span></a>
          <a href="https://www.enciclopedia.cat/ec-gec-0019925.xml" target="_blank" rel="noreferrer">Enciclopèdia Catalana <span>↗</span></a>
        </div>
      ...
      <section className="historyCta">
        ...
        <a className="button lightButton" href={sitePath("/agenda")}>Veure l’agenda <span>↗</span></a>
      </section>
    </main>
  );
}
